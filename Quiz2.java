...
public class Quiz2 implements ActionListener {
    ...
    String[][] options = { { "(P.Q+R)", "(P+Q.R)", "(P.Q+R) ", "(P.Q+R) " },
            { "Independent of one variable", "Independent of two variables", "Independent of three variables",
                    "Dependent on all the variables" },
            { "B’C’+B’D+BD", "B’C’+CD", "B’D+ AD’", "AB+CD’" }, { "f=(A + B’)(A’ + C)(B + C’)",
                    "f=(B' + C)(A' + B)(A + C')", "f=(A + B)(B’ + C)(A + C’)", "f=(B’ + C’)(A’ + B’)(A’ + C’)" },
            { "xy' + x'y", "xy' + x'y'", "x'y + xy", "xy + x'y'" } };
    char[] answers = { 'B', 'B', 'B', 'B', 'A' };
    char guess;
    char answer;
    int index;
